...
<head>
    <title><fmt:message key="unbarsub.title"/></title>
    <meta name="heading" content="<fmt:message key='unbarsub.heading'/>"/>
    <meta name="menu" content="OrderMenu"/>
    <script type="text/javascript" src="<c:url value='/scripts/selectbox.js'/>"></script>
</head>
<body>
<h2><fmt:message key="unbarsub.title"/></h2><br />
<spring:bind path="unbarSub.*">
...
<form:form class="form-horizontal" commandName="unbarSub" method="post" action="unbarSubForm" onsubmit="return onFormSubmit(this)" id="unbarSub">
...
<script type="text/javascript">
    Form.focusFirstElement($('unbarSub'));
    highlightFormElements();

<!-- This is here so we can exclude the selectAll call when roles is hidden -->
function onFormSubmit(theForm) {
	if (confirm("Are you sure to Unbar")) 
		return validateunbarSub(theForm);
	else
		return false; 
...
<v:javascript formName="unbarSub" staticJavascript="false"/>

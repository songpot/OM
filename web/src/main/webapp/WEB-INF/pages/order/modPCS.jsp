...
<head>
    <title><fmt:message key="modpcs.title"/></title>
    <meta name="heading" content="<fmt:message key='modpcs.heading'/>"/>
    <meta name="menu" content="OrderMenu"/>
    <script type="text/javascript" src="<c:url value='/scripts/selectbox.js'/>"></script>
</head>
<body>
<h2><fmt:message key="modpcs.title"/></h2><br />
...
<form:form class="form-horizontal" commandName="modPCS" method="post" action="modPCSForm" onsubmit="return onFormSubmit(this)" id="modPCS">

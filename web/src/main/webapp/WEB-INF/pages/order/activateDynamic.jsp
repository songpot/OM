...
<spring:bind path="activateDynamic.*">
...
<form:form class="form-horizontal" commandName="activateDynamic" method="post" action="activateDynamicForm" onsubmit="return onFormSubmit(this)" id="activateDynamic">
<input type="hidden" name="from" value="<c:out value="${param.from}"/>"/>

<div class="control-group">
   <p><fmt:message key="activateDynamic.message"/></p>
...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
     	<form:input path="iccid" id="iccid" cssClass="span3" cssErrorClass="text large error" maxlength="19"/>
    </div>
  </div>    
  <div class="control-group">   	
    <div class="controls">
...
<script type="text/javascript">
    Form.focusFirstElement($('activateDynamic'));
    highlightFormElements();

<!-- This is here so we can exclude the selectAll call when roles is hidden -->
function onFormSubmit(theForm) {
	if (confirm("Are you sure to Activate SubScriber")) 
		return validateActivateDynamic(theForm);
	else
		return false;  
...
<v:javascript formName="activateDynamic" staticJavascript="false"/>

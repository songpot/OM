...
<div class="span7">
    ...
    <c:if test="${cookieLogin != 'true'}">
        ...
        <fieldset >
            ...
            <div id="collapse-address" class="accordion-body in collapse">
                <fieldset class="control-group">
...
<c:choose>
    ...
    <c:when test="${not empty user.username}">
		...
		<fieldset >
            <fieldset class="control-group">
            <label class="control-label">Mobile Setting</label>
            <div class="controls">
                <label class="checkbox inline">
                    <form:checkbox path="postpaidSubmit" id="postpaidSubmit"/>
                    Can submit postpaid
                </label>
                <label class="checkbox inline">
                    <form:checkbox path="changeplanSubmit" id="changeplanSubmit"/>
                    Can changeplan without rule
                </label>
                <label class="checkbox inline">
                    <form:checkbox path="mvnoSubmit" id="mvnoSubmit"/>
                    Can submit MVNO Data
                </label>
            </div>
        </fieldset>

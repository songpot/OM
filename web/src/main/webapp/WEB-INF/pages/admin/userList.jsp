...
<body>
<div id="search">
<form class="form-search" method="get" action="${ctx}/admin/users" id="searchForm">
...
<input type="button" class="btn btn-invert" onclick="location.href='<c:url value="/mainMenu"/>'"

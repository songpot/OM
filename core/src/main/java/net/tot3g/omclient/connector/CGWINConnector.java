...
public interface CGWINConnector  {
	...
	public APPResponse adjustbalance(String msisdn,String amount,String type,String username);
	
	public APPResponse adjustbalance(String msisdn,String amount,String type,String username,String bucket);
}
